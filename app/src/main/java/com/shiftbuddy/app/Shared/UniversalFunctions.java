...
public class UniversalFunctions {
    ...
    public static String getShiftDateRangeString(String shiftBeginDateString, String shiftEndDateString) {
            ...
            DateTime shiftBeginDate = stringToDateTime(UniversalVariables.dateFormatDateTimeMilitary, shiftBeginDateString);
            DateTime shiftEndDate = stringToDateTime(UniversalVariables.dateFormatDateTimeMilitary, shiftEndDateString);

            if (shiftBeginDate.dayOfMonth().get() == shiftEndDate.dayOfMonth().get())
                return changeDateStringFormat(UniversalVariables.dateFormatDateTimeMilitary, UniversalVariables.dateFormatDateDisplayString, shiftBeginDateString) + System.getProperty("line.separator") +
                        changeDateStringFormat(UniversalVariables.dateFormatDateTimeMilitary, UniversalVariables.dateFormatTimeDisplayString, shiftBeginDateString) + " - " +
                        changeDateStringFormat(UniversalVariables.dateFormatDateTimeMilitary, UniversalVariables.dateFormatTimeDisplayString, shiftEndDateString);

            else
                return changeDateStringFormat(UniversalVariables.dateFormatDateTimeMilitary, UniversalVariables.dateFormatDateTimeDisplayString, shiftBeginDateString) + System.getProperty("line.separator") +
                        changeDateStringFormat(UniversalVariables.dateFormatDateTimeMilitary, UniversalVariables.dateFormatDateTimeDisplayString, shiftEndDateString);
